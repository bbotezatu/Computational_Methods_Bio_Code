...
def read_input(file_name):
   ...
   return n_val, exp_spectrum, answer

def leaderboard(n_val, exp_spectrum):
...
"""
def main():
   short_n_val, short_exp_spectrum, short_answer = read_input('P1_short.txt')
   
   if sorted(leaderboard(short_n_val, short_exp_spectrum).split('-')) == sorted(short_answer.split('-')):
   ...
   long_n_val, long_exp_spectrum, long_answer = read_input('P1_long.txt')
   if sorted(leaderboard(long_n_val, long_exp_spectrum).split('-')) == sorted(long_answer.split('-')):
